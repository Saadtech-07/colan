...
export function SeatCardContent({
  ...
  const className = cn(
    "flex h-full w-full flex-col items-center justify-start overflow-hidden rounded-[18px] border px-2.5 py-2.5 text-center transition-all duration-300 ease-out",
    occupied
  ...
  const children = (
    <>
      ...
      >
        <Armchair className="h-3 w-3 shrink-0 opacity-70" aria-hidden />
        {seatId}
