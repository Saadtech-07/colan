...
export const SYSTEM_ROLE_SEEDS: SystemRoleSeed[] = [
  {
    ...
    permissions: normalizeModulePermissions({
      ...
      dailyUpdates: { view: true, manage: true },
      progress: { view: true, manage: true },
      teamMembers: { view: true, manage: true },
      peopleDirectory: { view: true, manage: true },
  ...
  },
  {
    ...
    permissions: normalizeModulePermissions({
      ...
      projects: { view: true, manage: true },
      tasks: { view: true, manage: true },
      dailyUpdates: { view: true, manage: false, actions: { review: true } },
      progress: { view: true, manage: false, actions: { analytics: true } },
      teamMembers: { view: true, manage: false },
      peopleDirectory: { view: true, manage: false },
      ...
      approvals: { view: true, manage: false, actions: { approve: true } },
    }),
    displayOrder: 1,
  },
  {
    ...
    permissions: normalizeModulePermissions({
      ...
      projects: { view: true, manage: true },
      tasks: { view: true, manage: false, actions: { create: true, edit: true } },
      dailyUpdates: { view: true, manage: false, actions: { submit: true, review: true } },
      progress: { view: true, manage: false },
      teamMembers: { view: true, manage: false },
      peopleDirectory: { view: true, manage: false },
      seating: { view: true, manage: true },
      ...
      chat: { view: true, manage: false, actions: { send: true } },
      notifications: { view: true, manage: false },
      approvals: { view: false, manage: false },
    }),
  ...
  },
  {
    ...
    permissions: normalizeModulePermissions({
      ...
      dailyUpdates: { view: true, manage: false, actions: { submit: true } },
      progress: { view: true, manage: false },
      teamMembers: { view: true, manage: false },
      peopleDirectory: { view: true, manage: false },
      seating: { view: true, manage: false },
