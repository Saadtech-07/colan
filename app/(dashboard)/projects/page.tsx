  ...
  return (
    <ul className="space-y-3">
      {items.map((project) => {
        ...
        return (
          <li key={project.id}>
            <div className="group rounded-2xl border border-border/60 bg-background/80 p-4 transition-all duration-200 hover:-translate-y-0.5 hover:border-primary/20 hover:bg-background hover:shadow-sm">
              <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                <Link href={`/projects/${project.slug}`} className="min-w-0 flex-1 space-y-3">
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0 space-y-2">
                      <div className="flex items-center gap-2">
                        <p className="truncate text-sm font-semibold text-foreground transition-colors group-hover:text-primary sm:text-base">
                          {project.name}
                        </p>
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 xl:min-w-[220px] xl:flex-col xl:items-end">
                  <ProjectStatusSelect
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <Button
                      variant="outline"
                      size="icon"
                      className="h-9 w-9 rounded-2xl border-border/70 bg-background/80 shadow-sm"
                      asChild
                    >
